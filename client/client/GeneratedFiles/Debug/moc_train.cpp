...
#include "../../../../../../../../大一暑/c++/大作业/client (3)/client/client/train.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Train_t, stringdata) + ofs \
...
const QMetaObject Train::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Train.data,
      qt_meta_data_Train,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Train.stringdata))
